...
B<ifstat> [B<-a>] [B<-l>] [B<-z>] [B<-n>] [B<-v>] [B<-h>] [B<-t>] [B<-i> if0,if1,...] [B<-d> drv[:opt]] [B<-s> [comm@][#]host[/nn]] [B<-T>] [B<-A>] [B<-w>] [B<-W>] [B<-S>] [B<-M>] [B<-b>] [B<-q>] [delay[/delay] [count]]
...
Reports bandwidth in Mbytes/sec instead of kbytes/sec.
